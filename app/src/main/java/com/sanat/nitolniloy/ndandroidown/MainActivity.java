...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_home){
            ...
            Intent searchIntent = new Intent(MainActivity.this, ImportActivity.class);
            finish();
            ...
            Intent searchIntent = new Intent(MainActivity.this, ToolsActivity.class);
            finish();
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
            ...
            Intent searchIntent = new Intent(MainActivity.this, ShareActivity.class);
            finish();
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }
